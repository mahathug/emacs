...
(setq uboot-r5-make-cmd "make -j8 CROSS_COMPILE=arm-none-linux-gnueabihf- BINMAN_INDIRS=../../../../ti-linux-firmware  O=./out/am62x/r5")

(setq uboot-configure-cmd "make CROSS_COMPILE=aarch64-none-linux-gnu- am62x_evm_a53_defconfig O=./out/am62x/a53")

(setq uboot-make-cmd "make -j8 CROSS_COMPILE=aarch64-none-linux-gnu- BL31=../../../../bin/am62x/bl31.bin BINMAN_INDIRS=../../../../ti-linux-firmware TEE=../../../../bin/am62x/bl32.bin O=./out/am62x/a53")
